...
return (new CustomEvent(event_name,(function (){var obj29403 = {"detail":data};
return obj29403;
})()));
} else {
...
var f = (function (){var pred__29410 = cljs.core._EQ_;
var expr__29411 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29410.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29411))){
return ((function (pred__29410,expr__29411){
return (function (p1__29404_SHARP_){
return console.warn(p1__29404_SHARP_);
});
;})(pred__29410,expr__29411))
} else {
if(cljs.core.truth_(pred__29410.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29411))){
return ((function (pred__29410,expr__29411){
return (function (p1__29405_SHARP_){
return console.debug(p1__29405_SHARP_);
});
;})(pred__29410,expr__29411))
} else {
if(cljs.core.truth_(pred__29410.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29411))){
return ((function (pred__29410,expr__29411){
return (function (p1__29406_SHARP_){
return console.error(p1__29406_SHARP_);
});
;})(pred__29410,expr__29411))
} else {
return ((function (pred__29410,expr__29411){
return (function (p1__29407_SHARP_){
return console.log(p1__29407_SHARP_);
});
;})(pred__29410,expr__29411))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29414){
var map__29415 = p__29414;
var map__29415__$1 = ((((!((map__29415 == null)))?(((((map__29415.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29415.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29415):map__29415);
var opts = map__29415__$1;
var eval_fn = cljs.core.get.call(null,map__29415__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29417_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29419,(0),null);
var v = cljs.core.nth.call(null,vec__29419,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1531486667087
